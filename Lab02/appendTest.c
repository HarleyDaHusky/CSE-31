...
char* append(char s1[], char s2[]) {
    ...
    s1[s1len+s2len]='\0'; //makes index of the length of s1+s2 null, so the rest of space isn't wasted. And if the new append length is greater, the rest of the array gets deleted.
    return s1;
}
